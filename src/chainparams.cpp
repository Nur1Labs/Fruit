...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x828e579a02934826dbfa53a3dc33c169725b588ca6038e733d7066a5960b02f5"));
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1547702015; // 5 - Oct - 2018
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("044807d27f12615ca79f252b86ab74c554dcc5c8e0403d4f1470cca847389791cfa97c41bd04ede8bcf3b9a0c5434550be71b0133507ed4f2c671aa1353831739e") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1547702015;
	...
	vSeeds.push_back(CDNSSeedData("fruitofficial.com", "fruitofficial.com"));             // masterseed
	vSeeds.push_back(CDNSSeedData("seed.nur1labs.net", "seed.nur1labs.net"));             // masterseed
